...
public final class q extends AbstractC0483a implements Serializable {

    /* renamed from: o  reason: collision with root package name */
    public static final q f3889o;
    private static final long serialVersionUID = 3127340209035924785L;

    /* renamed from: d  reason: collision with root package name */
    private final transient String f3890d = "Hijrah-umalqura";

    /* renamed from: e  reason: collision with root package name */
    private final transient String f3891e = "islamic-umalqura";
    ...
    private transient int f3894i;

    /* renamed from: j  reason: collision with root package name */
    private transient int f3895j;

    /* renamed from: k  reason: collision with root package name */
    private transient int f3896k;

    /* renamed from: l  reason: collision with root package name */
    private transient int f3897l;

    /* renamed from: m  reason: collision with root package name */
    private transient int f3898m;

    /* renamed from: n  reason: collision with root package name */
    private transient int f3899n;

    static {
        q qVar = new q();
        f3889o = qVar;
        AbstractC0483a.l(qVar, "Hijrah");
        AbstractC0483a.l(qVar, "islamic");
    }
    ...
    private void m() {
        ...
        try {
            ...
            int[][] G4 = G();
            int s4 = (int) j$.time.i.O(1882, 11, 12).s();
            ...
            if (!this.f3891e.equals("islamic-umalqura")) {
            ...
            for (int i5 = 1300; i5 < 1600; i5++) {
                int i6 = (i5 * 12) - this.f3895j;
                int[] iArr2 = this.f3892g;
                int i7 = iArr2[i6 + 12] - iArr2[i6];
                this.f3898m = Math.min(this.f3898m, i7);
                this.f3899n = Math.max(this.f3899n, i7);
            }
            this.f = true;
        } catch (Exception e4) {
            throw new RuntimeException("Unable to initialize HijrahCalendar: " + str, e4);
        }
    }
    ...
    private int[] u(int i4, HashMap hashMap) {
        int[] iArr = new int[3613];
        this.f3896k = Integer.MAX_VALUE;
        ...
        for (int i6 = 1300; i6 <= 1600; i6++) {
            ...
            while (i7 < 12) {
                ...
                i4 += i8;
                this.f3896k = Math.min(this.f3896k, i8);
                this.f3897l = Math.max(this.f3897l, i8);
                i7++;
                i5 = i9;
            }
        }
    ...
    public final int[] D(int i4) {
        m();
        if (i4 < this.f3893h || i4 >= this.f3894i) {
            throw new RuntimeException("Hijrah date out of range");
        }
        int binarySearch = Arrays.binarySearch(this.f3892g, i4);
        if (binarySearch < 0) {
            binarySearch = (-binarySearch) - 2;
        }
        int i5 = this.f3895j;
        return new int[]{(binarySearch + i5) / 12, ((i5 + binarySearch) % 12) + 1, (i4 - this.f3892g[binarySearch]) + 1};
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final int E(int i4, int i5) {
        int i6 = (i5 - 1) + ((i4 * 12) - this.f3895j);
        if (i6 >= 0) {
    ...
    public final j$.time.temporal.w H(j$.time.temporal.a aVar) {
        ...
        if (aVar instanceof j$.time.temporal.a) {
            switch (p.f3888a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.w.k(this.f3896k, this.f3897l);
                case 2:
                    return j$.time.temporal.w.j(1L, this.f3899n);
                case WebSettingsBoundaryInterface.AttributionBehavior.APP_SOURCE_AND_APP_TRIGGER /* 3 */:
                    return j$.time.temporal.w.j(1L, 5L);
                case 4:
                case 5:
                    int i4 = this.f3895j;
                    return j$.time.temporal.w.j(i4 / 12, (((this.f3892g.length - 1) + i4) / 12) - 1);
                case 6:
    ...
    public final InterfaceC0484b k(j$.time.temporal.o oVar) {
        return oVar instanceof s ? (s) oVar : s.M(this, oVar.r(j$.time.temporal.a.EPOCH_DAY));
    }
    ...
    public final int r(long j4) {
        int i4 = this.f3895j;
        if (j4 < i4 / 12 || j4 > (((this.f3892g.length - 1) + i4) / 12) - 1) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final long z(int i4, int i5, int i6) {
        m();
        if (i5 < 1 || i5 > 12) {
            throw new RuntimeException("Invalid Hijrah month: " + i5);
        }
        int i7 = (i5 - 1) + ((i4 * 12) - this.f3895j);
        if (i7 < 0 || i7 >= this.f3892g.length) {
            throw new RuntimeException("Invalid Hijrah date, year: " + i4 + ", month: " + i5);
        } else if (i6 >= 1 && i6 <= E(i4, i5)) {
            return (i6 - 1) + this.f3892g[i7];
        } else {
