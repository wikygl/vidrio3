...
public final class E extends AbstractC0486d {
    ...
    private final transient j$.time.i f3862a;
    ...
    private int K() {
        return this.f3862a.K() - 1911;
    }

    private E M(j$.time.i iVar) {
        return iVar.equals(this.f3862a) ? this : new E(iVar);
    }
    ...
    public final InterfaceC0484b F(long j4, j$.time.temporal.u uVar) {
        return (E) super.z(j4, uVar);
    }

    @Override // j$.time.chrono.AbstractC0486d
    final InterfaceC0484b G(long j4) {
        return M(this.f3862a.S(j4));
    }

    @Override // j$.time.chrono.AbstractC0486d
    final InterfaceC0484b H(long j4) {
        return M(this.f3862a.T(j4));
    }

    @Override // j$.time.chrono.AbstractC0486d
    final InterfaceC0484b I(long j4) {
        return M(this.f3862a.U(j4));
    }
    ...
    */
    public final j$.time.chrono.E d(long r9, j$.time.temporal.r r11) {
        /*
            ...
            return r8
        L10:
            int[] r1 = j$.time.chrono.D.f3861a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            j$.time.i r3 = r8.f3862a
            r4 = 7
            r5 = 6
            r6 = 4
            if (r2 == r6) goto L4c
            ...
            goto L62
        L27:
            j$.time.chrono.C r11 = j$.time.chrono.C.f3860d
            ...
            return r9
        L4c:
            j$.time.chrono.C r2 = j$.time.chrono.C.f3860d
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof E) {
            return this.f3862a.equals(((E) obj).f3862a);
        }
        return false;
    }
    ...
    public final int hashCode() {
        C.f3860d.getClass();
        return this.f3862a.hashCode() ^ (-1990173233);
    }
    ...
    public final j$.time.temporal.w m(j$.time.temporal.r rVar) {
        if (rVar instanceof j$.time.temporal.a) {
            if (AbstractC0491i.h(this, rVar)) {
                ...
                int i4 = D.f3861a[aVar.ordinal()];
                if (i4 == 1 || i4 == 2 || i4 == 3) {
                    return this.f3862a.m(rVar);
                }
                if (i4 != 4) {
                    return C.f3860d.m(aVar);
                }
                j$.time.temporal.w j4 = j$.time.temporal.a.YEAR.j();
                return j$.time.temporal.w.j(1L, K() <= 0 ? (-j4.e()) + 1912 : j4.d() - 1911);
            }
    ...
    public final long r(j$.time.temporal.r rVar) {
        if (rVar instanceof j$.time.temporal.a) {
            int i4 = D.f3861a[((j$.time.temporal.a) rVar).ordinal()];
            if (i4 == 4) {
                int K3 = K();
                if (K3 < 1) {
                    K3 = 1 - K3;
