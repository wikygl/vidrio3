...
public abstract class M extends AbstractCollection implements Serializable, Collection {

    /* renamed from: j  reason: collision with root package name */
    public static final Object[] f3682j = new Object[0];
    ...
    public final Object[] toArray(Object[] objArr) {
        ...
        if (length < size) {
            ...
            if (m4 == null) {
                ...
                return Arrays.copyOfRange(m4, l(), k(), objArr.getClass());
            }
        } else if (length > size) {
            objArr[size] = null;
        }
